...
cv2.createTrackbar('Hue Low','myTracker',90,180,onTrack1)
...
cv2.createTrackbar('Sat Low','myTracker',55,255,onTrack3)
cv2.createTrackbar('Sat High','myTracker',255,255,onTrack4)
cv2.createTrackbar('Val Low','myTracker',25,255,onTrack5)
...
while True:
    ...
    for contour in contours:
        ...
        if area>=200:
            ...
            xCorner=int((x/width)*1920)
            yCorner=int((y/height)*1080)
    ...
    cv2.moveWindow('my WEBcam',xCorner,yCorner)
